...
// GET export all trips as CSV (Managers and Financial Analysts only)
router.get('/csv', authenticateToken, verifyRole(['Fleet Manager', 'Financial Analyst']), async (req, res) => {
  try {
    ...
    // Flatten raw query output to match Parser expectations
